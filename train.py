...
def main(args):
    ...
    #for epoch in range(args.num_epochs):
        ...
        for batch in train_loader:
            ...
            #model_teacher.py
            pred_traj = net(obs_traj.cuda(), num_ped, pred_traj_gt.cuda())
            loss = displacement_error(pred_traj, pred_traj_gt.cuda())
        ...
        logger.info('the smallest ade is {}'.format(fin_ade))
